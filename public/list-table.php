...
<div class="mx-auto" style="width: 70vw; margin-top: 2rem;">
  <span class="label label-default" style=" display:block;font-weight: 900; text-transform: uppercase; margin-bottom:1.2rem;"><i class="fa-solid fa-table"></i> Your Complete List of Tables</span>
  <ul class="list-group">
